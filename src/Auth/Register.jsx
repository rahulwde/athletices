...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4   bg-gradient-to-r "
              >
        
      <div className="justify-center items-center bg-[#083344] md:flex gap-10 h-3/4  shadow-lg rounded-2xl lg:px-20 p-4">
